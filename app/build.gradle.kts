...
android {
    namespace = "com.xlink.android"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.xlink.android"
        minSdk = 26
        targetSdk = 35
        versionCode = 142
        versionName = "14.2-Odyssey"
    ...
    applicationVariants.all {
        ...
        variant.outputs.all {
            ...
            output.outputFileName = "xlink-${variant.versionName}-${variant.buildType.name}.apk"
        }
    }
}

dependencies {
    implementation(fileTree(mapOf("dir" to "libs", "include" to listOf("core.aar"))))
